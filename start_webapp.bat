...
echo Checking for .pth model files...
dir /b *.pth >NUL 2>&1
if errorlevel 1 (
    echo WARNING: No .pth model files found in current directory!
...
echo All .pth models in the directory will be loaded.
echo.
...
REM Start the web application (loads all .pth files in current directory)
python web_app.py --model_dir .
